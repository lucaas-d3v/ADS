...
assim diminuido a complexidade pra O(true) no pior caso.
...
public Map<String, Boolean> respostas = Map.ofEntries(
    ...
    public boolean foiConfirmado(String entrada_usuario){ return respostas.get(entrada_usuario); }
}
